...
function SheetOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // pointer-events-auto: overlay must receive taps so outside-dismiss works
        "fixed inset-0 z-50 bg-black/50 pointer-events-auto data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
        className,
      )}
      {...props}
    />
