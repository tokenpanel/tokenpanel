...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">): React.ReactElement {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all duration-200 ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] hover:after:bg-sidebar-border sm:flex",
...
function SidebarInput({ className, ...props }: React.ComponentProps<typeof Input>): React.ReactElement {
  return (
    <Input
...
function SidebarSeparator({ className, ...props }: React.ComponentProps<typeof Separator>): React.ReactElement {
  return (
    <Separator
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring outline-hidden transition-transform duration-200 ease-linear hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuButton({
  ...
  className,
  ...props
}: SidebarMenuButtonProps & VariantProps<typeof sidebarMenuButtonVariants>): React.ReactElement {
  const Comp = asChild ? Slot : "button";
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 text-sidebar-foreground ring-sidebar-ring outline-hidden transition-transform duration-200 ease-linear peer-hover/menu-button:text-sidebar-accent-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
        "after:absolute after:-inset-2 md:after:hidden",
...
function SidebarMenuBadge({ className, ...props }: React.ComponentProps<"div">): React.ReactElement {
  return (
    <div
...
function SidebarMenuSkeleton({ className, showIcon = false, ...props }: SidebarMenuSkeletonProps): React.ReactElement {
...
function SidebarMenuSubItem({ className, ...props }: React.ComponentProps<"li">): React.ReactElement {
  return (
    <li
