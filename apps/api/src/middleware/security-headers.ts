 ...
 * SPA is split-origin (VITE_API_BASE_URL), the document origin's CSP is what
 * the browser enforces — set CSP_CONNECT_SRC to that API origin if this server
 * also serves the HTML (or if an edge reuses this policy string).
 */
